...
public class BenchmarkTest {
    ...
    @Test
    public void runBenchmarkSinglePass() {
        Log.d("Checklist", "Start runBenchmarkSinglePass");
        Assert.assertTrue(testing.Testing.benchmarkTraceForAndroid(
                trace, Testing.PirTypeSinglePass, stdOut, stdErr));
        Log.d("Checklist", "End runBenchmarkSinglePass");
    }
