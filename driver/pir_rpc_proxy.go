...
func (p *RpcProxy) UpdateServer(updateIdxs []int, newRows []pir.Row) error { return nil}
func (p *RpcProxy) UpdateClient(u pir.UpdateReq, resp *interface{}) error {return nil}
/*--------------------------------------------------------------------------------------------------*/
